...
#
##### Q1: Show that the minimum order statistic converges in probability to 0. 
...
***
##### Q2-5: Visualize and approximate the probability statement above. 
...
***
##### Q5: Create a plot with the sample size on the x-axis and the probability of interest on the y-axis. 
...
***
##### Q6: Explain how the plot above can help someone understand convergence in probability to a constant.

Per the plot, we see that as the sample size increases, the probability of being within the 0.5 boundary increases. If the sample size were to continue to increase, we'd get closer and closer values to 1. Thus, it illustrates that as our sample size increase, so does the probability and if we were to increase to infinity the probability would converge to 1.


***
##### Q7: Create a plot with the sample size on the x-axis and the values of the minimum on the y-axis. 
...
***
##### Q8: Explain how the plot above can help someone understand convergence in probability to a constant.

Per the plot, we see that as the sample size increases, the our minimums become less and less dispersed. As we continue increasing the sample size the upper bound continues to dicrease, ultimately converging to 0, should n increase to infinity.
