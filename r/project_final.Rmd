...
Per the plot, we see that as the sample size increases, the probability of being within the 0.05 boundary increases. If the sample size were to continue to increase, we'd get closer and closer values to 1. Thus, it illustrates that as our sample size increases, so does the probability and if we were to increase to infinity the probability would converge to 1.
...
Per the plot, we see that as the sample size increases, the our minimums become less and less dispersed. As we continue increasing the sample size the upper bound continues to decrease, ultimately converging to 0, should n increase to infinity.
...
Lorem ipsum dolor sunt amet locquitur.
