...
***
##### 1.2-5) Visualize and approximate the probability statement above. 
...
```{md}
(This is the old answer. I'll remove after any edits to Draft #2) Per the plot, we see that as the sample size increases, the our minimums become less and less dispersed. As we continue increasing the sample size the upper bound continues to decrease, ultimately converging to 0, should n increase to infinity.
```
